...
<template>
  ...
  >
    <h4 class="font-bold text-4xl text-gray-500">
      400 | <span class="font-light">{{ errMsg }}</span>
    </h4>
  </div>
  ...
  >
    <h4 class="font-bold text-4xl text-gray-500">
      401 | <span class="font-light">{{ errMsg }}</span>
    </h4>
  </div>
  ...
  >
    <h4 class="font-bold text-4xl text-gray-500">
      403 | <span class="font-light">{{ errMsg }}</span>
    </h4>
  </div>
  ...
  >
    <h4 class="font-bold text-4xl text-gray-500">
      404 | <span class="font-light">{{ errMsg }}</span>
    </h4>
  </div>
